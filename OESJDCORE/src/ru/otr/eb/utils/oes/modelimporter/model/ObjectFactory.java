...
{
  private static final QName _PolicyStore_QNAME = new QName("http://www.otr.ru/eb/policystore", "policyStore");
  ...
  public JAXBElement<TPolicyStoreDesc> createPolicyStore(TPolicyStoreDesc value)
  {
    return new JAXBElement(_PolicyStore_QNAME, TPolicyStoreDesc.class, null, value);
  }
}
